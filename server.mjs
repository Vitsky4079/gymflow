...
// Defaults to loopback-only. Set HOST=0.0.0.0 to also accept LAN connections
// (e.g. a phone testing the mobile app's 3D gym embed against this server).
...
server.listen(port,host,() => {
  ...
  if (host === '0.0.0.0') console.log(`Also reachable from this network at http://<this computer's LAN IP>:${port}`);
