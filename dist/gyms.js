import {equipment,presets} from './data.js';
export const gyms=[
{id:'studio',name:'Studio 01',description:{en:'Open-plan training studio',pl:'Otwarta przestrzeń treningowa'},floors:1,width:36,depth:30,minZ:-13.5,maxZ:16.5,placements:equipment.map(e=>({id:e.id,x:e.x,z:e.z,floor:0})),presets,obstacles:[{x:-5.6,z:-7.5,w:.8,d:.8},{x:5.6,z:-7.5,w:.8,d:.8},{x:-5.6,z:7.5,w:.8,d:.8},{x:5.6,z:7.5,w:.8,d:.8}]},
...
presets:[{id:'full',name:'Całe ciało A',description:'6 ćwiczeń · około 45 min',ids:['treadmill','legcurl','chest','lat','row','shoulder']},{id:'upper',name:'Góra ciała',description:'6 ćwiczeń · około 45 min',ids:['treadmill','pullup','chest','row','shoulder','cable']},{id:'lower',name:'Nogi + plecy',description:'5 ćwiczeń · około 40 min',ids:['treadmill','hipthrust','legcurl','legextension','lat']}],obstacles:[{x:0,z:-8,w:.5,d:5,floor:0},{x:-10,z:1,w:7,d:.5,floor:1}],stairs:{x:10,z:7}}
];
